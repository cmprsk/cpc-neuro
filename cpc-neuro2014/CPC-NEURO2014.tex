...
\makeevenfoot{headings}{\thepage}{}{Versão de outubro de 2019 - CC-BY 4.0 FHC Felix 2014-2019}
\makeoddfoot{headings}{Versão de outubro de 2019 - CC-BY 4.0 FHC Felix 2014-2019}{}{\thepage}
\makeevenhead{plain}{}{}{}
\makeoddhead{plain}{}{}{}
...
\newcommand*{\titleGP}
	{\begingroup % Geometric Modeling
		...
		\raggedright
			...
			{\huge Manual de tratamento clínico de pacientes pediátricos com tumores cerebrais \\[0.5\baselineskip]}
			%\rule{\textwidth}{0.4pt}\vspace*{-\baselineskip}\vspace{3.2pt}
			\rule{\textwidth}{1.6pt}\\[\baselineskip]
			\scshape
			\Large Félix, Francisco H. C.; Fontenele, Juvenia B.
                        \\
                        \large Versão de outubro de 2019 (13/10/2019)
			\vfill
			\par
		\raggedleft
...
\newcommand*{\titleM}
	{\begingroup % Geometric Modeling
		...
		\centering
			\vspace*{\baselineskip}
			{\LARGE Manual de
			tratamento clínico de pacientes pediátricos com tumores cerebrais
			\\[0.5\baselineskip]}
			\scshape
			{\Large Protocolos de quimioterapia \\[0.5\baselineskip]}\par
			\vfill
...
{\let\thefootnote\relax\footnotetext{Versão Junho/2020}}
\small{
...
\textbf{Elegível:} Estadiamento pré-tratamento: mais de 0,5cm de tumor residual (RNM de controle até 21 dias pós-op, preferido 72h após); sem metástases (RNM de neuro-eixo e PL/MO). Tratamento precisa iniciar até 56 dias após cirurgia. Apenas EPENDIMOMA (excluindo espinhal). Pacientes com mais de 12 meses de idade. Somente iniciar o protocolo após a assinatura do TERMO DE CONSENTIMENTO INFORMADO, conforme acordado. NÃO INICIAR ESTE PROTOCOLO EM CRIANÇAS GRAVEMENTE ENFERMAS.
