...
\begin{contributors}
%\name{Orlandira Leite de Araújo,} Centro Pediátrico do Câncer, Hospital Infantil Albert Sabin, Fortaleza, Ceará
...
\node (start) [startstop] {Tumor cerebral};
\node (in1) [io, below of=start] {Idade > 3 anos};
\node (pro1) [process, below of=in1] {RM};
\node (dec1) [decision, below of=pro1, yshift=-0.5cm] {Espinhal?};
\node (pro2a) [process, below of=dec1] {Ressecção cirúrgica};
\node (pro2b) [process, right of=dec1, xshift=2cm] {Cirurgia exclusiva};
\node (dec2) [decision, below of=pro2a, yshift=-0.5cm] {Completa?};
\node (pro3a) [process, below of=dec2] {Imagem NE};
\node (pro3b) [process, right of=dec2, xshift=2cm] {Considerar Terapia Adjuvante};
\node (dec3) [decision, below of=pro3a, yshift=-0.5cm] {Metastático?};
\node (pro4a) [process, below of=dec3] {Radioterapia local 59,4 Gy};
\node (pro4b) [process, right of=dec3, xshift=2cm] {Radioterapia NE};
\node (out1) [io, below of=pro4a] {Remissão completa};
\node (stop) [startstop, below of=out1] {Seguimento};
\draw [arrow] (start) -- (in1);
\draw [arrow] (in1) -- (pro1);
\draw [arrow] (pro1) -- (dec1);
\draw [arrow] (pro2a) -- (dec2);
\draw [arrow] (pro3a) -- (dec3);
\draw [arrow] (dec1) -- node[anchor=east] {não} (pro2a);
\draw [arrow] (dec1) -- node[anchor=south] {sim} (pro2b);
\draw [arrow] (dec2) -- node[anchor=east] {sim} (pro3a);
\draw [arrow] (dec2) -- node[anchor=south] {não} (pro3b);
\draw [arrow] (dec3) -- node[anchor=east] {sim} (pro4a);
\draw [arrow] (dec3) -- node[anchor=south] {não} (pro4b);
\draw [arrow] (dec2) -- (pro3a);
\draw [arrow] (pro4a) -- (out1);
...
{\let\thefootnote\relax\footnotetext{Versão Setembro/2017}}
