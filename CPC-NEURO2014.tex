...
\begin{center}
\begin{figure}[htpb]
\includegraphics[scale=0.75,trim = 30mm 10mm 8mm 15mm,clip]{fig1.pdf}
\caption{Tratamento de crianças com tumores cerebrais, com histologia}
%\label{Rotulo}
\end{figure}
\begin{figure}[!htb]
\includegraphics[scale=0.79,trim = 20mm 50mm 10mm 13mm,clip]{fig2.pdf}
...
\begin{figure}[!htb]
\includegraphics[scale=0.8,trim = 18mm 30mm 15mm 12mm,clip]{fig3.pdf}
...
\begin{center}
\begin{longtable}{p{1cm}p{4.5cm}|p{4.5cm}|p{2.5cm}}
    \hline
...
\begin{center}
\begin{longtable}{@{}p{1cm}p{2cm}|p{2cm}|p{1cm}|p{3.5cm}|p{2.5cm}@{}}
	\hline
...
\textbf{\tiny{Máximo de 8 doses de VCR, máximo de 20 dias recebendo RT cranioespinhal, máximo de 51 dias de RT no total}}
\end{center}
\pagebreak
\subsection{Manutenção: 04 ciclos A e 04 ciclos B}

\begin{center}
\begin{longtable}{p{1cm}p{5.5cm}|p{1cm}|p{3cm}|p{1.5cm}}
	\hline
...
\footnotesize
\begin{center}
\begin{longtable}{@{}p{1cm}c|p{4.4cm}|p{1.5cm}p{1.5cm}|c|c@{}}
	\hline
    ...
    \hline
\end{longtable}
\begin{longtable}{@{}p{1cm}c|p{4.4cm}|p{1.8cm}p{1.7cm}|c|c@{}}
	\hline
...
\begin{longtable}{@{}p{1cm}c|p{4.3cm}|p{1.5cm}p{1.5cm}|c|c@{}}
	\hline
...
\begin{center}
\begin{longtable}{p{1cm}c|p{4.7cm}|p{1.5cm}p{1.5cm}|c|c}
	\hline
	\multicolumn{7}{c}{Ciclo 1} \\
	\hline
	\multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Data}&{}&\multicolumn{1}{c|}{Leuco}&\multicolumn{1}{c|}{Plaq}&{Administrado}&{Rubrica} \\
...
\begin{center}
\begin{longtable}{p{1cm}p{4cm}|p{1cm}|p{4.5cm}|p{2cm}}
	\hline
...
\begin{longtable}{p{4.9cm}|p{4.5cm}|p{4cm}}
    \hline
...
\begin{center}
    \begin{longtable}{p{1cm}p{5cm}|p{1cm}|p{3.5cm}|p{2cm}}
    \hline
	\multicolumn{5}{c}{\textbf{CICLO 1}}\\
	\hline
    \multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Dose}&{Data}&{Administrado}&{Rubrica} \\
...
\subsection{Manutenção: 06 ciclos}
\begin{center}
\begin{longtable}{p{1cm}p{4cm}|p{1.5cm}|p{4cm}|p{2cm}}
	\hline
	\multicolumn{5}{c}{\textbf{CICLO 1}}\\
\hline
    \multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Dose}&{Data}&{Administrado}&{Rubrica} \\
...
\clearpage
\begin{center}
\begin{longtable}{p{1cm}c|p{3.5cm}|p{2cm}p{2cm}|c|c}
	\hline
	\multicolumn{7}{c}{PEV} \\
	\hline
	\multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Data}&{}&\multicolumn{1}{c|}{Leuco}&\multicolumn{1}{c|}{Plaq}&{Administrado}&{Rubrica} \\
...
\begin{center}
\begin{longtable}{p{1cm}c|p{5cm}|p{1cm}p{1.7cm}|c|c}
	\hline
	\multicolumn{7}{c}{Vincristina semanal} \\
	\hline
	\multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Data}&{}&{}&&{Administrado}&{Rubrica} \\
...
\begin{center}
\begin{longtable}{p{1cm}c|p{4.5cm}|p{1.5cm}p{1.5cm}|c|c}
	\hline
	\multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Data}&{}&\multicolumn{1}{c|}{Leuco}&\multicolumn{1}{c|}{Plaq}&{Administrado}&{Rubrica} \\
    \hline
    ...
    \hline
\end{longtable}
\begin{longtable}{p{1cm}c|p{3.6cm}|p{2cm}p{2cm}|c|c}
	\hline
	\multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Data}&{}&{}&&{Administrado}&{Rubrica} \\
    \hline
    \multicolumn{1}{c|}{\textbf{8}}&&{Vincristina \(1,5\) mg/m\(^2\)/dia}&\multicolumn{1}{c}{}&&{(  ) Sim (  ) Não}&\\
...
\begin{center}
\begin{longtable}{p{1cm}|p{0.6cm}|p{4.5cm}|p{1.5cm}p{1.5cm}|c|p{0.9cm}}
...
\begin{center}
\begin{longtable}{p{1cm}p{4cm}|p{1cm}|p{2.5cm}|p{2.4cm}}
	\hline
	\multicolumn{5}{c}{\textbf{CICLO 1}}\\
\hline
    \multicolumn{1}{c|}{\multirow{1}{*}{\textbf{Dia}}}&{Dose}&{Data}&{Administrado}&{Rubrica} \\
...
\end{longtable}
\textbf{Intervalo de 14 dias.}
\begin{longtable}{p{5cm}|p{4.4cm}|p{4cm}}
    \hline
    \textbf{Exames (data):}&{Neut (\(>7,5\times10^2\)):}&{Plaq (\(>7,5\times10^4\)):}
    \\
    \hline
