...
\begin{center}
\begin{table}[H]
	\begin{tabular}{p{2.0cm}|p{5.5cm}|p{9.5cm}}
    \hline
		\multicolumn{1}{c|}{\multirow{3}{*}{\textbf{Everolimo}}}&{\(1,5 - 10\) mg/m\(^2\)}&{Manter concentração sérica entre \(5-15\) ng/ml}\\
    ...
    \hline
		{Apresentação:}&{Comprimidos de 0,5 e 1 mg (Certican)}&{}\\
		{}&{Comprimidos de 2,5 e 5 mg (Afinitor)}&{}\\
    \hline
\end{tabular}
\end{table}
\end{center}
