...
\begin{center}
\begin{table}[H]
\begin{tabular}{p{1.3cm}p{5cm}|p{7cm}|p{1,5cm}}
    \hline
    \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{S1}}}&{Interferon alfa 2b}&{Administrado: (  ) Sim (  ) Não}&{Rubrica}\\
    \multicolumn{1}{c|}{}&{Intracístico lento 3.000.000 UI}&{Datas:}&\\
...
\begin{center}
\begin{table}[H]
\begin{tabular}{p{1.3cm}p{4.7cm}|p{7.5cm}|p{1,3cm}}
    \hline
    \multicolumn{1}{c|}{\multirow{2}{*}{\textbf{S1}}}&{Interferon alfa 2b}&{Administrado: (  ) Sim (  ) Não}&{Rubrica}\\
    \multicolumn{1}{c|}{}&{Subcutâneo 3.000.000 UI}&{Datas:}&\\
    \multicolumn{1}{c|}{}&{Pode dobra a dose}&{D1: \_\_\_/\_\_\_/\_\_\_ D3:\_\_\_/\_\_\_/\_\_\_ D5: \_\_\_/\_\_\_/\_\_\_}&\\
    \hline
    {Exames:}&{Neut(\(>1,5\times10^3\)):}&{Plaq(\(>10^5\)):}&{}
    \\
    \hline
