...
\begin{tabular}{c|c|c|c|c}
	\hline
	\multicolumn{1}{c|}{\multirow{3}{*}{DMB}}&{0-5}&{M0R0+}&{MYC/N(-/+)}&{P1}	\\
	\cline{2-5}
	\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{\multirow{2}{*}{>5}}&{M0R0}&{MYC/N(-/?)}&{P2}
	\\
	\cline{3-5}
	\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{}&{M0R+}&{MYC/N(+)}&{P3}\\
        \hline
	\multicolumn{1}{c|}{\multirow{3}{*}{CMB}}&{0-3}&{M0R0+}&{MYC/N(-/+)}&{P1}	\\
	\cline{2-5}
	\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{\multirow{2}{*}{>4}}&{M0R0}&{MYC/N(-/?)}&{P2}
	\\
	\cline{3-5}
	\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{}&{M0R+}&{MYC/N(+)}&{P3}\\
        \hline
	\multicolumn{1}{c|}{\multirow{3}{*}{LCAMB}}&{0-3}&{M0R0+}&{MYC/N(-/+)}&{P1}	\\
	\cline{2-5}
	\multicolumn{1}{c|}{}&\multicolumn{1}{c|}{\multirow{2}{*}{>4}}&{M0/1R0+}&{MYC/N(-/+)}&{P2}
	\\
	\hline
